                                    ...
                                    <div className="row">
                                        <div className="col-lg-12">
                                            <div className="normal-order">
                                                <h2 className="normal-text">Today's Night Orders</h2>
                                                                ...
                                                                night.length > 0 ? (
                                                                    night.map(night => (
                                                                        <div key={night._id} className="order-menu-list"
                                                                            ...
                                                                            <span className="order-list-text">{night.status}</span>
                                                                        </div>
                                                                    ))
                                                                ) : (
...
export default VendorDashboardNight
