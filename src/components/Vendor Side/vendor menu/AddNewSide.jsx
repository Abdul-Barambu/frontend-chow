...
const AddNewSide = ({ handleAddDish }) => {
    ...
    const handleAddNewSide = (e) => {
        e.preventDefault()
        axios.post("https://api-chow.onrender.com/api/vendors/menu/custom/sides", {
            name: name,
            price: price
        }, {headers})
        .then(response => {
            ...
            Swal.fire({
                icon: 'success',
                title: 'SUCCESS',
                text: 'Side added successfully, Click OK to continue'
            });
        }).catch(e => {
            console.log(e)
            Swal.fire({
        ...
        <div>
            <div className="payment-container-add">
                ...
                <div className='input-food-div'>
                    <form onSubmit={handleAddNewSide}>
                        <div className="form">
                            <div className="mb-3">
